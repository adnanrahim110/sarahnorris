      ...
      <div className="w-full px-3 mx-auto">
            ...
            <div className="row items-center justify-between gap-y-5">
              {verses.map((verse, idx) => (
                <div key={idx} className="md:w-4/12">
                  <div className="bg-primary-50/10 border md:mx-3.5 border-primary pt-5 pb-10 px-6 rounded-[10px] text-center relative">
        ...
        <div className="row justify-between items-center mt-16 gap-y-5">
          <div className="lg:w-7/12">
            <div className="w-full bg-primary-50/10 p-4 rounded-[10px] border border-secondary-300 max-md:text-center">
            ...
            <div className="row gap-y-2">
              {crisResources.map((resource, idx) => (
                <div key={idx} className="w-full max-md:text-center">
                  <a
                    href={resource.url}
                    className="block w-full bg-primary-50/10 border border-secondary-300 p-5 rounded-[10px]"
                  >
